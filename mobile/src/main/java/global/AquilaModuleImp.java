...
import org.aquilaj.core.TransactionConfidence;
...
import global.aquila.DefaultCoinSelector;
...
public class AquilaModuleImp implements AquilaModule {

    private static final Logger logger = LoggerFactory.getLogger(AquilaModuleImp.class);
    ...
    public AquilaModuleImp(ContextWrapper contextWrapper, WalletConfiguration walletConfiguration,ContactsStoreDao contactsStore,RateDbDao rateDb,BackupHelper backupHelper) {
...
//    }
    ...
    public Transaction completeTxWithCustomFee(Transaction transaction,Coin fee) throws InsufficientMoneyException{
        ...
        walletManager.completeSend(sendRequest);
        // if the fee is different to the custom fee and the tx size is lower than 1kb (1000 bytes in aquila core)
...
//                    }
    ...
    public AquilaRate getRate(String coin) {
   ...
   public boolean isSyncWithNode() throws NoPeerConnectedException {
    ...
    @Override
    public List<AquilaRate> listRates() {
        return rateDb.list();
    }
    ...
    public void saveRate(AquilaRate aquilaRate){
        rateDb.insertOrUpdateIfExist(aquilaRate);
    }
