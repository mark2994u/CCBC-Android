package ccbc.org.ccbcwallet.ui.transaction_request_activity;
...
import ccbc.org.ccbcwallet.ui.transaction_send_activity.AmountInputFragment;
import ccbc.org.ccbcwallet.utils.DialogsUtil;
import ccbc.org.ccbcwallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static ccbc.org.ccbcwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static ccbc.org.ccbcwallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = ccbcModule.getFreshNewAddress().toBase58();

        NetworkParameters params = ccbcModule.getConf().getNetworkParams();

        String ccbcURI = CcbcURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(ccbcURI);
        qrDialog.setQrText(ccbcURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String ccbcURI) throws WriterException {
