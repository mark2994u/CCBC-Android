package ccbc.org.ccbcwallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "ccbc.org.ccbcwallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ccbcApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ ccbcApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return ((CcbcModuleImp)ccbcApplication.getModule()).getWallet().toString(false,true,true,null);
    }
}
