package ccbc.org.ccbcwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = ccbcModule.backupWallet(backupFile, firstPassword);

            if (result){
                ccbcApplication.getAppConf().setHasBackup(true);
