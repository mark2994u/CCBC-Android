package ccbc.org.ccbcwallet.ui.export_account;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = ccbcModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(CcbcContext.NETWORK_PARAMETERS);
