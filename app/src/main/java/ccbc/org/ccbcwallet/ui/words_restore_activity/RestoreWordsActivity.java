package ccbc.org.ccbcwallet.ui.words_restore_activity;
...
import org.ccbcj.crypto.MnemonicException;
...
import ccbc.org.ccbcwallet.ui.transaction_send_activity.MyFilterableAdapter;
import ccbc.org.ccbcwallet.ui.transaction_send_activity.MyTextWatcher;
...
import static ccbc.org.ccbcwallet.module.CcbcContext.CCBC_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = ccbcModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            ccbcModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            ccbcModule.restoreWallet(mnemonic, CCBC_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (ccbcApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!ccbcApplication.getAppConf().isAppInit()){
                                                            ccbcApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, CcbcContext.ENABLE_BIP44_APP_VERSION));
