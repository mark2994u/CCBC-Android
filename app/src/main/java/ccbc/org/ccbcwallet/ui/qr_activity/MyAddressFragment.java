...
import static ccbc.org.ccbcwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(CcbcModule ccbcModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(ccbcModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = CcbcApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String ccbcUri = CcbcURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(ccbcUri,address.toBase58());
            }
    ...
    public void setModule(CcbcModule module) {
        this.module = module;
    }
