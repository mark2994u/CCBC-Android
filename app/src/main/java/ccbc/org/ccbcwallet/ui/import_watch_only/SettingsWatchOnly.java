package ccbc.org.ccbcwallet.ui.import_watch_only;
...
import org.ccbcj.wallet.DeterministicKeyChain;
...
import static ccbc.org.ccbcwallet.utils.CrashReporter.appendSavedBackgroundTraces;
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                ccbcModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_CCBC_ONLY
                );
