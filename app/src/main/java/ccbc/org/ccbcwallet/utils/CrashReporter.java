...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final CcbcApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (CcbcContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + CcbcContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((CcbcModuleImp)application.getModule()).getWallet();
