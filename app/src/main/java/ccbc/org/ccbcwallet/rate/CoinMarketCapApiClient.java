...
public class CoinMarketCapApiClient {
    ...
    public class CcbcMarket{
        ...
        public CcbcMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public CcbcMarket getCcbcPxrice() throws RequestCcbcRateException{
        try {
            CcbcMarket ccbcMarket = null;
            String url = this.URL + "ticker/ccbc/";
            ...
            e.printStackTrace();
            throw new RequestCcbcRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestCcbcRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestCcbcRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestCcbcRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
